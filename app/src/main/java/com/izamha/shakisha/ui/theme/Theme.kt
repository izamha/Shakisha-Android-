package com.izamha.shakisha.ui.theme
...
private val LightColorPalette = ShakishaColors(
    brand = Shadow5,
...
private val DarkColorPalette = ShakishaColors(
    brand = Shadow1,
...
object ShakishaTheme {
    val colors: ShakishaColors
        @Composable
        get() = LocalJetsnackColors.current
}

/**
 * Shakisha custom Color Palette
 */
@Stable
class ShakishaColors(
    ...
    fun update(other: ShakishaColors) {
    ...
    fun copy(): ShakishaColors = ShakishaColors(
...
private val LocalJetsnackColors = staticCompositionLocalOf<ShakishaColors> {
    error("No JetsnackColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [ShakishaTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
