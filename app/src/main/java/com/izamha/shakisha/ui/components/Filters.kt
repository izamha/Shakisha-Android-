            ...
            IconButton(onClick = onShowFilters) {
                Icon(
                    ...
                    modifier = Modifier.diagonalGradientBorder(
                        colors = ShakishaTheme.colors.interactiveSecondary,
                        shape = CircleShape
                    )
                )
            }
...
fun FilterChip(
    ...
    val backgroundColor by animateColorAsState(
        if (selected) ShakishaTheme.colors.brandSecondary else ShakishaTheme.colors.uiBackground
        // TODO: Do something when the FilterChip is selected or not.
    )
    ...
    val textColor by animateColorAsState(
        if (selected) Color.Black else ShakishaTheme.colors.textSecondary
    )
        ...
        val backgroundPressed =
            if (pressed) {
                Modifier.offsetGradientBackground(
                    ShakishaTheme.colors.interactiveSecondary,
                    200f,
                    0f
                )
            } else {
